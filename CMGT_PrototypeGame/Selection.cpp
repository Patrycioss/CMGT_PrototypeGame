...
Selection::Selection(CMGT_PrototypeGame& game) 
	: SFP::Scene("Selection")
	, game_(game)
	, choices_{std::make_unique<SFP::AnimationSprite>(sf::Vector2f {130,170}, "characters/illidan.png", 4, 4, 1)
...
void Selection::MakeStartButton() {
	...
	startButton_->text().setFont(*SFP::ResourceManager::LoadFont("fonts/minecraftFont.ttf"));
...
void Selection::MakeDifficultySelection() 
{
	...
	for (std::unique_ptr<Button>& button : difficultyButtons_)
	{
		...
		button->text().setFont(*SFP::ResourceManager::LoadFont("fonts/minecraftFont.ttf"));
...
void Selection::MakeNameCreation() {
	...
	chooseYourName_.setFont(*SFP::ResourceManager::LoadFont("fonts/minecraftFont.ttf"));
	...
	maxCharactersWarning_.setFont(*SFP::ResourceManager::LoadFont("fonts/minecraftFont.ttf"));
