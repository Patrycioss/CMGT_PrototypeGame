...
void AnimationSprite::SetFrame(const unsigned int& frame)
{
...
void AnimationSprite::UpdateSize()
{
	GameObject::UpdateSize((float) frameWidth_, (float) frameHeight_);
}

const unsigned int& AnimationSprite::startFrame() const {
	return startFrame_;
}

const unsigned int& AnimationSprite::currentFrame() const {
	return currentFrame_;
}

const unsigned int& AnimationSprite::cycleLength() const {
	return cycleFrameCount_;
}

void AnimationSprite::SetDelay(const unsigned int& animationDelay)
{
